package com.upm.wallavic.config;
...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "wallavic@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "wallavic API";

        private String description = "wallavic API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "wallavic";
